...
public:
	...
	*/
	...
	// Things that I added
	// make it virtual so Trap and Prize function can be called accordingly
	virtual int  getScoreUpdate(int timeDelay);   // calculate the score
	
	virtual string say();  //display the message
